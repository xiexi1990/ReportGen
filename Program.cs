...
namespace ReportGen
{
    partial class A
    {
        ...
        string[] __unitnamelist = { "安徽省", "北京市", "重庆市", "震防中心", "福建省", "广东省", "甘肃省", "广西壮族自治区", "河南省", "湖北省", "河北省", "海南省", "黑龙江省", "湖南省", "地壳应力研究所", "地震预测研究所", "地质研究所", "地球物理研究所", "吉林省", "江苏省", "江西省", "辽宁省", "内蒙古自治区", "宁夏回族自治区", "青海省", "四川省", "山东省", "上海市", "陕西省", "山西省", "天津市", "新疆维吾尔自治区", "西藏自治区", "云南省", "浙江省" };
        ...
        public OracleConnection oracon, oracon2;
        ...
        DateTime the_date = new DateTime(2016, 6, 1, 0, 0, 0);
     ...
     //       wordapp.Visible = true;
       ...
       //     datestr_abid = "(" + datestr + "and a.ab_id >=1 and a.ab_id <= 7)";
        ...
        ~A()
        {
            worddoc.SaveAs2("d:\\month16_6_1test");
            wordapp.Visible = true;
            //     worddoc.Close();
            //     wordapp.Quit();
